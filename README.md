...
The Api root is https://certii.hyskyapi.cc/apihandle.php
...
https://certii.hyskyapi.cc/apihandle.php?req=search&query=aspectoftheend <br>
This will return 200 AOTEs auctions sorted by ending time.
<br>
<br>
but what if you want more?
<br>
https://certii.hyskyapi.cc/apihandle.php?req=search&query=aspectoftheend&page=1
<br>
...
- You can search for enchanted books and items using /ebs (enchants)
  - Example: https://certii.hyskyapi.cc/apihandle.php?req=search&query=/ebs%20power5&page=1
